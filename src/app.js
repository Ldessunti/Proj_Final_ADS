...
app.post('/modelCliente', async(req, res) => {
  try{
    ...
    //Teste
    console.log(name, email, telefone, senha, createdAt, updatedAt);
...
app.get('/modelCliente/:id', async(req, res) => {
  try{
    const { id } = req.params;
...
//Produto - id, name, quantidadeEstoque, preco, descricao, createdAt, updatedAt

//Produto - POST

app.post('/modelProduto', async(req, res) => {
  try{
    const { name, quantidadeEstoque, preco, descricao, createdAt, updatedAt } = req.body;
      
    //Teste
    console.log(name, quantidadeEstoque, preco, descricao, createdAt, updatedAt);
...
//Barbeiro - id, name, email, telefone, especialidade, createdAt, updatedAt

//Barbeiro - POST

app.post('/modelBarbeiro', async(req, res) => {
  try{
    const { name, email, telefone, especialidade, createdAt, updatedAt } = req.body;
      
    //Teste
    console.log(name, email, telefone, especialidade);

    const newBarbeiro = await Barbeiro.create({name, email, telefone, especialidade, createdAt, updatedAt});
...
//Corte - id, descricao, preco, duracao, createdAt, updatedAt
...
app.post('/modelCorte', async(req, res) => {
  try{
    ...
    //Teste
    console.log(descricao, preco, duracao, createdAt, updatedAt);
